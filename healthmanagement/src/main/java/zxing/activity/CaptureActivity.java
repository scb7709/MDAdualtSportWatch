...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private Button capture_mask_openlight;
    ...
    public void onCreate(Bundle icicle) {
        ...
        activity = this;
        getParameterHttp(false);//获取采样参数
        temperatureeAndWeathere = (TemperatureeAndWeathere) getIntent().getSerializableExtra("temperatureeAndWeathere");
        if (temperatureeAndWeathere == null) {
            getTemperatureeAndWeathere(false);
        }
        ...
        capture_mask_openlight = (Button) findViewById(R.id.capture_mask_openlight);
        ...
        capture_mask_openlight.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void openLight(boolean isOpen) {
        ...
        Log.i("m_Camera", "m_Camera");
        if (m_Camera == null && cameraManager != null) {
      ...
      /*  bundle.putInt("width", mCropRect.width());
        ...
        if (MAC.matches(reg)) {
            if (postParameterRequest != null) {
                ...
                getParameterHttp(true);
            }
            // startActivity(new Intent(CaptureActivity.this, WatchBlueTestActivity.class).putExtra("flag", "firstsport").putExtra("MAC", rawResult.getText()));
        } else {
            MyToash.Toash(activity, "请扫描指定腕表设备");
            finish();
        }
    ...
    private void getParameterHttp(final boolean flag) {
