...
public class smallSeekCircle extends smallProgressCircle {
    /**
    ...
    public interface OnSeekCircleChangeListener {
         ...
         */
        void onProgressChanged(smallSeekCircle seekCircle, int progress, boolean fromUser);
         ...
         */
        void onStartTrackingTouch(smallSeekCircle seekCircle);
         ...
         * @param seekCircle The SeekCircle in which the touch gesture began
         */
        void onStopTrackingTouch(smallSeekCircle seekCircle);
    }
    ...
    public smallSeekCircle(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public smallSeekCircle(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public smallSeekCircle(Context context) {
        super(context);
    }
