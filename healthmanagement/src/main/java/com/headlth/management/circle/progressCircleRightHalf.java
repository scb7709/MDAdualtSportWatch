...
public class progressCircleRightHalf extends View {
    ...
    public progressCircleRightHalf(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initAttributes(context, attrs);
    }

    public progressCircleRightHalf(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttributes(context, attrs);
    }

    public progressCircleRightHalf(Context context) {
        super(context);
    }
