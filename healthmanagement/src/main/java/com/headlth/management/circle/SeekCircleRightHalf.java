...
public class SeekCircleRightHalf extends progressCircleRightHalf {
    /**
    ...
    public interface OnSeekCircleChangeListener {
         ...
         */
        void onProgressChanged(SeekCircleRightHalf seekCircle, int progress, boolean fromUser);
         ...
         */
        void onStartTrackingTouch(SeekCircleRightHalf seekCircle);
         ...
         * @param seekCircle The SeekCircle in which the touch gesture began
         */
        void onStopTrackingTouch(SeekCircleRightHalf seekCircle);
    }
    ...
    public SeekCircleRightHalf(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public SeekCircleRightHalf(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SeekCircleRightHalf(Context context) {
        super(context);
    }
...
//修改。更改是否为可以点击
        ...
        Log.e("pree",mMaxProgress+":::"+mMinProgress);
