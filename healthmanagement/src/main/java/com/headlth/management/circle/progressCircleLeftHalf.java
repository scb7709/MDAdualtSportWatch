...
public class progressCircleLeftHalf extends View {
    ...
    public progressCircleLeftHalf(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initAttributes(context, attrs);
    }

    public progressCircleLeftHalf(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttributes(context, attrs);
    }

    public progressCircleLeftHalf(Context context) {
        super(context);
    }
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        try {
         ...
         /* //这里更改数值
            ...
            mColor1 = attributes.getColor(R.styleable.SeekCircle_startColor, Color.parseColor("#ffffff"));
            mColor2 = attributes.getColor(R.styleable.SeekCircle_endColor, Color.parseColor("#ffffff"));
            mInactiveColor = attributes.getColor(R.styleable.SeekCircle_inactiveColor, Color.parseColor("#ffb809"));
