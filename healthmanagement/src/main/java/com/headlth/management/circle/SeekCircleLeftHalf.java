...
public class SeekCircleLeftHalf extends progressCircleLeftHalf {
    /**
    ...
    public interface OnSeekCircleChangeListener {
         ...
         */
        void onProgressChanged(SeekCircleLeftHalf seekCircle, int progress, boolean fromUser);
         ...
         */
        void onStartTrackingTouch(SeekCircleLeftHalf seekCircle);
         ...
         * @param seekCircle The SeekCircle in which the touch gesture began
         */
        void onStopTrackingTouch(SeekCircleLeftHalf seekCircle);
    }
    ...
    public SeekCircleLeftHalf(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public SeekCircleLeftHalf(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SeekCircleLeftHalf(Context context) {
        super(context);
    }
