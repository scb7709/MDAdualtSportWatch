...
public class CarouselView extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private void init() {
        ...
        for (int i=0;i<count;i++){
            ...
            if (currentPosition==i){
                ...
                LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(pageItemWidth + dip2px(context,3),pageItemWidth + dip2px(context,3));
    ...
    protected void onFinishInflate() {
        ...
        pageItemWidth = dip2px(context,5);
