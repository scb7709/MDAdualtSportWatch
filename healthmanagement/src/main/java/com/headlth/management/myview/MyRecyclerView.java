...
import com.headlth.management.adapter.MyRecyclerViewAdapter;
...
public class MyRecyclerView extends RecyclerView {
    ...
    MyRecyclerViewAdapter myWrapAdapter;
    ...
    public void setAdapter(Adapter adapter) {
        ...
        View refreshView = LayoutInflater.from(getContext()).inflate(R.layout.recycleview_circle_refresh, null);
        ...
        myWrapAdapter = new MyRecyclerViewAdapter(adapter, headers, footers);
