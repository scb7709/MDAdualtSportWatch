...
public class PullToRefreshLayout extends RelativeLayout {
    ...
    public void refreshFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            ...
            case 0:
                // 刷新失败
                refreshStateTextView.setText("当前没有新数据");
                refreshStateImageView.setBackgroundResource(R.mipmap.refresh_succeed);
                break;
            default:
                refreshStateTextView.setText("刷新了" + refreshResult + "条数据");
                refreshStateImageView.setBackgroundResource(R.mipmap.refresh_succeed);
                break;
    ...
    public void loadmoreFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            ...
            default:
                // 加载失败
                loadStateTextView.setText("加载了" + refreshResult + "条数据");
                loadStateImageView.setBackgroundResource(R.mipmap.load_succeed);
                break;
        }
        if (pullUpY < 0) {
    ...
    private void changeState(int to) {
        ...
        switch (state) {
            ...
            case RELEASE_TO_REFRESH:
                // 释放刷新状态
                refreshStateTextView.setText("释放立即更新");
