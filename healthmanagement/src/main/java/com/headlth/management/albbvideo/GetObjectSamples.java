package com.headlth.management.albbvideo;
...
public class GetObjectSamples {
    ...
    public void getObjectSample() {
        ...
        try {
            ...
            Log.i("Content-Length", "" + getResult.getContentLength());
            ...
            Log.i("asyncGetObjectSample", "download success.");

            // 下载后可以查看文件元信息
            ObjectMetadata metadata = getResult.getMetadata();
            Log.i("ContentType", metadata.getContentType());
